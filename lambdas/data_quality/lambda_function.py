...
ATHENA_S3_OUTPUT = os.environ.get("ATHENA_S3_OUTPUT", "s3://yt-dataprocessing-s3-athena-query-results-ritwick-portfolio/")
...
def lambda_handler(event, context):
    ...
    {
        "layer": "silver",
        "database": "yt-datapipeline-gluedb-silver",
        "tables": ["clean_statistics", "clean_reference_data"]
    }
    """
    database = event.get("database", "yt-datapipeline-gluedb-silver")
